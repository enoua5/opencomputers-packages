declare module "dns" {
    ...
    export function register(name: string, timeout?: number): boolean;
    export function unregister(name: string, timeout?: number): boolean;
    export function resolve(name: string, timeout?: number): any;
}
